...
from tralda.datastructures.DoublyLinkedList import DLList, DLListNode, DLListIterator
...
class EvoSeq(DLList):
    ...
    def append(self, value, status, site_id, parent_el=None, rate_class=0, rate_factor=1.0):
        new_end = EvoSeqNode(
            value,
            status,
            site_id,
    ...
    def append_left(self, value, status, site_id, parent_el=None, rate_class=0, rate_factor=1.0):
    ...
    def insert_right_of(
        self, element, value, status, site_id, parent_el=None, rate_class=0, rate_factor=1.0
    ):
