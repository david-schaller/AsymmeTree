"""Evolve sequences along a tree using models for substitution, indels, and rate heterogeneity.
...
class Evolver:
    def __init__(self, subst_model, indel_model=None, het_model=None, gillespie="auto", **kwargs):
        """
        Parameters
        ----------
    ...
    def get_sequences(self, include_inner=True):
        ...
        if include_inner:
            ...
            return {
                v: self.subst_model.to_sequence(seq)
    ...
    def true_alignment(self, include_inner=True, write_to=None, alignment_format="phylip"):
