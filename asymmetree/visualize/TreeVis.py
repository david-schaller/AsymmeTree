...
def assign_species_colors(tree):
    ...
    -------
    dict
        A dictionary containing the labels of the extant species as keys and
...
def assign_gene_colors(tree, species_colors=None):
    ...
    species_colors : dict, optional
        A dictionary containing the values of the 'color' attribute appearing
        in the tree as keys and assigned colors as values.

    Returns
    -------
    dict
        A dictionary containing the labels of the extant genes as keys and
        the assigned colors as values.
    """
...
def assign_colors(species_tree, gene_tree):
    ...
    -------
    tuple of two dicts
        Dictionaries containing the labels of the extant species/genes as keys
...
def visualize(tree, color_dict=None, save_as=False, scale_symbols=1.0, fontsize="medium"):
    """Visualize a tree.
    ...
    color_dict : dict, optional
        A dictionary containing as values the assigned color for each label
...
class Visualizer:
    ...
    def __init__(
        self, tree, color_dict=None, scale_symbols=1.0, fontsize="medium", species_info=False
    ):
        """
        Parameters
        ----------
