...
Thus, rates for the three event types (\texttt{DLH\_rates}), autocorrelation (\texttt{autocorr\_variance}), the distribution of base rates (\texttt{base\_rate\_distr}) etc.\ can be specified. 
...
gs.simulate_gene_trees(50, DLH_rates=(1.0, 0.5, 0.0),
