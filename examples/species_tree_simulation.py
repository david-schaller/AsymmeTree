...
print("EBDP age ------------------------")
tree4 = te.species_tree_age(
    2.0, model="EBDP", birth_rate=1.0, episodes=[(1.0, 0.3, 0.8, 0.0), (0.9, 0.4, 0.7, 0.3)]
)
...
print("EBDP n age ------------------------")
tree6 = te.species_tree_n_age(10, 1.0, model="BDP", birth_rate=1.0, death_rate=0.5)
